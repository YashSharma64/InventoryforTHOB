...
// node_modules/@medusajs/dashboard/dist/order-create-exchange-GHJEQAEE.mjs
        ...
        (0, import_jsx_runtime9.jsxs)("div", { className: "mb-2 flex items-center justify-between", children: [
          ...
          (0, import_jsx_runtime9.jsx)("span", { className: "txt-small text-ui-fg-subtle", children: getStylizedAmount(
            inboundPreviewItems.reduce((acc, item) => {
              ...
              acc = acc + ((action == null ? void 0 : action.details.quantity) || 0) / item.quantity * item.total;
              return acc;
            }, 0) * -1,
            order.currency_code
          ) })
...
//# sourceMappingURL=order-create-exchange-GHJEQAEE-XR4WO5NU.js.map
