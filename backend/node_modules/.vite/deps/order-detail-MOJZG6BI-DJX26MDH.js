...
import {
  ...
  useClaims
} from "./chunk-R3KKFWCN.js";
import {
  useCancelExchange,
  useCancelExchangeRequest,
  useExchanges
} from "./chunk-ENGEYRJP.js";
import {
...
import {
  ...
  useReturns
} from "./chunk-TCFDCXNY.js";
import {
  useCancelOrderEdit,
  useConfirmOrderEdit
} from "./chunk-24NH6MPQ.js";
import {
  getLoyaltyPlugin
...
import {
  useDate
} from "./chunk-LM26J55U.js";
import {
  useExtension
} from "./chunk-FTD3ZWHZ.js";
import {
  Thumbnail
} from "./chunk-BEQKVDIQ.js";
import {
  Skeleton,
...
import {
  useReservationItems
} from "./chunk-TT6OZ3KG.js";
import {
  useStockLocation
} from "./chunk-TOIAOH2C.js";
...
// node_modules/@medusajs/dashboard/dist/order-detail-MOJZG6BI.mjs
  ...
  return (0, import_react2.useMemo)(() => {
    ...
    for (const fulfillment of order.fulfillments || []) {
      ...
      if (fulfillment.shipped_at) {
        items.push({
          ...
          children: (0, import_jsx_runtime8.jsxs)("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2", children: [
            (0, import_jsx_runtime8.jsx)(FulfillmentCreatedBody, { fulfillment, isShipment: true }),
    ...
    for (const ret of returns) {
      ...
      items.push({
        ...
        itemsMap,
        children: (0, import_jsx_runtime8.jsxs)("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2", children: [
          (0, import_jsx_runtime8.jsx)(ReturnBody, { orderReturn: ret, isCreated: !ret.canceled_at }),
        ...
        items.push({
          title: (0, import_jsx_runtime8.jsx)(
            change_details_tooltip_default,
            {
              ...
              previous: (0, import_jsx_runtime8.jsx)("p", { className: "txt-compact-small text-ui-fg-subtle", children: update.actions[0].details.old }),
              next: (0, import_jsx_runtime8.jsx)("p", { className: "txt-compact-small text-ui-fg-subtle", children: update.actions[0].details.new })
            }
          ),
          timestamp: update.created_at,
          children: (0, import_jsx_runtime8.jsxs)("div", { className: "text-ui-fg-subtle mt-2 flex gap-x-2 text-sm", children: [
...
var OrderEditBody = ({ edit }) => {
  ...
  const ItemChangeDetails = ({
    ...
    return (0, import_jsx_runtime8.jsx)("div", { className: "text-ui-fg-subtle flex flex-col divide-y divide-dashed", children: lineItems.map((orderItem) => {
      ...
      return (0, import_jsx_runtime8.jsxs)("div", { className: "group flex items-start gap-x-4 py-3 first:pt-0 last:pb-0", children: [
...
var Item = ({
  ...
  const hasInventoryKit = isInventoryManaged && ((((_c = (_b = item.variant) == null ? void 0 : _b.inventory_items) == null ? void 0 : _c.length) || 0) > 1 || ((_e = (_d = item.variant) == null ? void 0 : _d.inventory_items) == null ? void 0 : _e.some((i) => i.required_quantity > 1)));
...
var DiscountAndTotalBreakdown = ({
  ...
  const { t } = useTranslation();
  const [isDiscountOpen, setIsDiscountOpen] = (0, import_react6.useState)(false);
  const [isCreditLinesOpen, setIsCreditLinesOpen] = (0, import_react6.useState)(false);
  const creditLines = order.credit_lines ?? [];
  const loyaltyPlugin = getLoyaltyPlugin(plugins);
  const discounts = (0, import_react6.useMemo)(() => {
    const discounts2 = [];
...
//# sourceMappingURL=order-detail-MOJZG6BI-DJX26MDH.js.map
