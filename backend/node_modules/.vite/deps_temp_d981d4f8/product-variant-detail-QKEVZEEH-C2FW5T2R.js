...
// node_modules/@medusajs/dashboard/dist/product-variant-detail-QKEVZEEH.mjs
...
var VariantMediaSection = ({ variant }) => {
  ...
  const media = (variant.images || []).filter(
    (image) => {
      var _a;
      return (_a = image.variants) == null ? void 0 : _a.some((variant2) => variant2.id === variant2.id);
    }
  );
...
//# sourceMappingURL=product-variant-detail-QKEVZEEH-C2FW5T2R.js.map
