...
function createElement(Type, props) {
  ...
  if (React2.isValidElement(render)) {
    ...
    element = (0, import_jsx_runtime.jsx)(Type, { ...rest });
  }
  if (wrapElement) {
...
function createStoreContext(providers = [], scopedProviders = []) {
  ...
  const ContextProvider = (props) => {
    return providers.reduceRight(
      (children3, Provider) => (0, import_jsx_runtime.jsx)(Provider, { ...props, children: children3 }),
      (0, import_jsx_runtime.jsx)(context.Provider, { ...props })
    );
  };
  const ScopedContextProvider = (props) => {
    return (0, import_jsx_runtime.jsx)(ContextProvider, { ...props, children: scopedProviders.reduceRight(
      (children3, Provider) => (0, import_jsx_runtime.jsx)(Provider, { ...props, children: children3 }),
...
// node_modules/@ariakit/react-core/esm/__chunks/PFMLR6AF.js
...
var useCompositeItem = createHook(
  function useCompositeItem2({
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime2.jsx)(CompositeItemContext.Provider, { value: providerValue, children: element }),
      [providerValue]
    );
    props = {
...
var useTab = createHook(function useTab2({
  ...
  const hasActiveItem2 = useStoreState(
    store,
  ...
  if (store.composite) {
    ...
    props = {
      ...props,
      render: (0, import_jsx_runtime3.jsx)(
        CompositeItem,
        {
          ...defaultProps,
          render: store.combobox && store.composite !== store.combobox ? (0, import_jsx_runtime3.jsx)(CompositeItem, { ...defaultProps, store: store.combobox }) : defaultProps.render
        }
      )
    };
  }
...
var useComposite = createHook(
  function useComposite2({
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime4.jsx)(CompositeContextProvider, { value: store, children: element }),
      [store]
    );
...
var useTabList = createHook(
  function useTabList2({ store, ...props }) {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime5.jsx)(TabScopedContextProvider, { value: store, children: element }),
      [store]
    );
    if (store.composite) {
      props = {
...
var useDisclosureContent = createHook(function useDisclosureContent2({ store, alwaysVisible, ...props }) {
  ...
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime6.jsx)(DialogScopedContextProvider, { value: store, children: element }),
    [store]
  );
...
var DisclosureContent = forwardRef2(function DisclosureContent2({
  ...
  return (0, import_jsx_runtime6.jsx)(DisclosureContentImpl, { ...props });
});
...
var useTabPanel = createHook(
  function useTabPanel2({
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime7.jsx)(TabScopedContextProvider, { value: store, children: element }),
      [store]
    );
    props = {
      role: "tabpanel",
...
// node_modules/@ariakit/react-core/esm/__chunks/OFU5CPWY.js
  ...
  for (const row of rows) {
    for (let i = 0; i < maxLength; i += 1) {
      ...
      if (!item || focusShift && item.disabled) {
        const isFirst = i === 0;
        const previousItem = isFirst && focusShift ? findFirstEnabledItem2(row) : row[i - 1];
...
// node_modules/@ariakit/react-core/esm/__chunks/JLXDN6B2.js
...
// node_modules/@ariakit/react-core/esm/__chunks/2LJOJZ7V.js
...
// node_modules/@ariakit/react-core/esm/__chunks/NA5OAMY5.js
...
var useToolbar = createHook(
  function useToolbar2({
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime9.jsx)(ToolbarScopedContextProvider, { value: store, children: element }),
      [store]
    );
    props = {
      role: "toolbar",
...
// node_modules/@ariakit/react-core/esm/__chunks/ZJNEJAJQ.js
...
// node_modules/@ariakit/react-core/esm/__chunks/US3QBMU2.js
...
var useCompositeContainer = createHook(function useCompositeContainer2({ store, ...props }) {
  ...
  const isOpenRef = (0, import_react17.useRef)(false);
...
// node_modules/@ariakit/react-core/esm/__chunks/TWDUFIV2.js
var TagName15 = "hr";
...
// node_modules/@ariakit/react-core/esm/__chunks/PKM3NWHS.js
var TagName16 = "hr";
...
// node_modules/@ariakit/react-core/esm/__chunks/VI2TRTYW.js
...
// node_modules/@ariakit/react-core/esm/__chunks/V7AYTPG7.js
...
// node_modules/@ariakit/react-core/esm/__chunks/OQWWYG3J.js
var TagName18 = "span";
...
// node_modules/@ariakit/react-core/esm/__chunks/DPTNUR7A.js
var TagName19 = "span";
...
// node_modules/@ariakit/react-core/esm/__chunks/EKSBXE4P.js
...
var usePortal = createHook(function usePortal2({
  ...
  const [anchorPortalNode, setAnchorPortalNode] = (0, import_react19.useState)(
    null
  );
  ...
  props = useWrapElement(
    ...
    (element) => {
      ...
      (0, import_jsx_runtime11.jsx)(PortalContext.Provider, { value: portalNode || context, children: element });
      ...
      element = (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
        preserveTabOrder && portalNode && (0, import_jsx_runtime11.jsx)(
          FocusTrap,
          {
            ref: innerBeforeRef,
      ...
      let preserveTabOrderElement = (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
        preserveTabOrder && portalNode && (0, import_jsx_runtime11.jsx)(
          FocusTrap,
          {
            ref: outerBeforeRef,
        ...
        (0, import_jsx_runtime11.jsx)("span", { "aria-owns": portalNode == null ? void 0 : portalNode.id, style: { position: "fixed" } }),
        preserveTabOrder && portalNode && (0, import_jsx_runtime11.jsx)(
          FocusTrap,
          {
            ref: outerAfterRef,
...
var HeadingContext = (0, import_react20.createContext)(0);

// node_modules/@ariakit/react-core/esm/__chunks/5M6RIVE2.js
var import_react21 = __toESM(require_react(), 1);
var import_jsx_runtime12 = __toESM(require_jsx_runtime(), 1);
function HeadingLevel({ level, children: children3 }) {
  const contextLevel = (0, import_react21.useContext)(HeadingContext);
  const nextLevel = Math.max(
    Math.min(level || contextLevel + 1, 6),
    1
  );
  return (0, import_jsx_runtime12.jsx)(HeadingContext.Provider, { value: nextLevel, children: children3 });
}

// node_modules/@ariakit/react-core/esm/__chunks/PONOZD7A.js
var import_jsx_runtime13 = __toESM(require_jsx_runtime(), 1);
var TagName21 = "div";
var useFocusableContainer = createHook(function useFocusableContainer2({ autoFocusOnShow = true, ...props }) {
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime13.jsx)(FocusableContext.Provider, { value: autoFocusOnShow, children: element }),
    [autoFocusOnShow]
  );
  return props;
});
...
// node_modules/@ariakit/react-core/esm/__chunks/YA3YOKXH.js
...
// node_modules/@ariakit/react-core/esm/__chunks/YYYHIDZC.js
...
function useNestedDialogs(store) {
  ...
  const providerValue = (0, import_react24.useMemo)(() => ({ store, add }), [store, add]);
...
// node_modules/@ariakit/react-core/esm/__chunks/VIQYURFN.js
...
// node_modules/@ariakit/react-core/esm/__chunks/A4D5O6EK.js
...
// node_modules/@ariakit/react-core/esm/__chunks/PIQ7VIUQ.js
var TagName22 = "div";
var elements = [
  "a",
  "button",
...
var Role = forwardRef2(
  ...
  function Role2(props) {
    return createElement(TagName22, props);
  }
);
Object.assign(
  Role,
...
// node_modules/@ariakit/react-core/esm/__chunks/3BBVQAZ3.js
...
function DialogBackdrop({
  ...
  if ((0, import_react27.isValidElement)(backdrop)) {
    return (0, import_jsx_runtime15.jsx)(Role, { ...props, render: backdrop });
  }
  const Component = typeof backdrop !== "boolean" ? backdrop : "div";
  return (0, import_jsx_runtime15.jsx)(Role, { ...props, render: (0, import_jsx_runtime15.jsx)(Component, {}) });
}
...
// node_modules/@ariakit/react-core/esm/__chunks/GKPFMPRM.js
...
var useDialog = createHook(function useDialog2({
  ...
  const [autoFocusEnabled, setAutoFocusEnabled] = (0, import_react28.useState)(false);
  (0, import_react28.useEffect)(() => {
    if (!open) return;
  ...
  const [hasOpened, setHasOpened] = (0, import_react28.useState)(false);
  (0, import_react28.useEffect)(() => {
    if (!open) return;
    setHasOpened(true);
    return () => setHasOpened(false);
  }, [open]);
  const focusOnHide = (0, import_react28.useCallback)(
    (dialog, retry = true) => {
      const { disclosureElement } = store.getState();
  ...
  const focusedOnHideRef = (0, import_react28.useRef)(false);
  useSafeLayoutEffect(() => {
    if (open) return;
    if (!hasOpened) return;
  ...
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime16.jsx)(HeadingLevel, { level: modal ? 1 : void 0, children: element }),
    [modal]
  );
  ...
  const [headingId, setHeadingId] = (0, import_react28.useState)();
  const [descriptionId, setDescriptionId] = (0, import_react28.useState)();
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime16.jsx)(DialogScopedContextProvider, { value: store, children: (0, import_jsx_runtime16.jsx)(DialogHeadingContext.Provider, { value: setHeadingId, children: (0, import_jsx_runtime16.jsx)(DialogDescriptionContext.Provider, { value: setDescriptionId, children: element }) }) }),
    [store]
  );
  props = {
    "data-dialog": "",
...
function createDialogComponent(Component, useProviderContext = useDialogProviderContext) {
  return forwardRef2(function DialogComponent(props) {
    ...
    return (0, import_jsx_runtime16.jsx)(Component, { ...props });
  });
}
...
// node_modules/@ariakit/react-core/esm/__chunks/4IWMRS2E.js
...
var usePopover = createHook(
  function usePopover2({
    ...
    const defaultArrowElementRef = (0, import_react29.useRef)(null);
    const [positioned, setPositioned] = (0, import_react29.useState)(false);
    const { portalRef, domReady } = usePortalRef(portal, props.portalRef);
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime17.jsx)(
        "div",
        {
          ...wrapperProps,
          style: {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime17.jsx)(PopoverScopedContextProvider, { value: store, children: element }),
      [store]
    );
    props = {
...
// node_modules/@ariakit/react-core/esm/__chunks/U3PAIVHS.js
...
function useAutoFocusOnHide({
  ...
  const [autoFocusOnHide, setAutoFocusOnHide] = (0, import_react30.useState)(false);
  const mounted = useStoreState(store, "mounted");
  ...
  const finalFocusRef = (0, import_react30.useRef)(null);
  (0, import_react30.useEffect)(() => {
...
var NestedHovercardContext = (0, import_react30.createContext)(null);
var useHovercard = createHook(
  function useHovercard2({
    ...
    const [nestedHovercards, setNestedHovercards] = (0, import_react30.useState)([]);
    const hideTimeoutRef = (0, import_react30.useRef)(0);
    const enterPointRef = (0, import_react30.useRef)(null);
    const { portalRef, domReady } = usePortalRef(portal, props.portalRef);
    ...
    const registerOnParent = (0, import_react30.useContext)(NestedHovercardContext);
    useSafeLayoutEffect(() => {
      if (modal) return;
      if (!portal) return;
      if (!mounted) return;
    ...
    const registerNestedHovercard = (0, import_react30.useCallback)(
      (element) => {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime18.jsx)(HovercardScopedContextProvider, { value: store, children: (0, import_jsx_runtime18.jsx)(NestedHovercardContext.Provider, { value: registerNestedHovercard, children: element }) }),
...
var useTooltip = createHook(
  function useTooltip2({
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime19.jsx)(TooltipScopedContextProvider, { value: store, children: element }),
      [store]
    );
...
// node_modules/@ariakit/react-core/esm/__chunks/AY4MU2OE.js
...
var useHovercardAnchor = createHook(
  function useHovercardAnchor2({ store, showOnHover = true, ...props }) {
    ...
    const disabled = disabledFromProps(props);
    const showTimeoutRef = (0, import_react31.useRef)(0);
    (0, import_react31.useEffect)(() => () => window.clearTimeout(showTimeoutRef.current), []);
    ...
    const ref = (0, import_react31.useCallback)(
      (element) => {
        if (!store) return;
        const { anchorElement } = store.getState();
...
var useTooltipAnchor = createHook(
  function useTooltipAnchor2({ store, showOnHover = true, ...props }) {
    ...
    const canShowOnHoverRef = (0, import_react32.useRef)(false);
    ...
    const contentId = useStoreState(store, (state) => {
      var _a;
...
// node_modules/@ariakit/react-core/esm/__chunks/BCNP3AN4.js
...
function useComputedStyle(store) {
  const [style, setStyle] = (0, import_react33.useState)();
  const contentElement = useStoreState(store, "contentElement");
  useSafeLayoutEffect(() => {
    if (!contentElement) return;
    const win = getWindow(contentElement);
...
var usePopoverArrow = createHook(
  function usePopoverArrow2({
    ...
    const [borderWidth, isRing] = (0, import_react33.useMemo)(() => {
    ...
    const children3 = (0, import_react33.useMemo)(
      () => (0, import_jsx_runtime20.jsx)("svg", { display: "block", viewBox: "0 0 30 30", children: (0, import_jsx_runtime20.jsxs)("g", { transform, children: [
        ...
        (0, import_jsx_runtime20.jsx)("path", { fill: "none", d: POPOVER_ARROW_PATH, mask: `url(#${maskId})` }),
        (0, import_jsx_runtime20.jsx)("path", { stroke: "none", d: POPOVER_ARROW_PATH }),
        (0, import_jsx_runtime20.jsx)("mask", { id: maskId, maskUnits: "userSpaceOnUse", children: (0, import_jsx_runtime20.jsx)(
          "rect",
          {
            x: "-15",
            y: "0",
...
var useTooltipArrow = createHook(
  function useTooltipArrow2({ store, size: size2 = 16, ...props }) {
    ...
    props = usePopoverArrow({ store, size: size2, ...props });
    return props;
  }
);
...
// node_modules/@ariakit/react-core/esm/__chunks/EK7GBBE3.js
...
var MenuItemCheckedContext = (0, import_react34.createContext)(
  void 0
);

// node_modules/@ariakit/core/esm/__chunks/WSDJ6ZRB.js
...
// node_modules/@ariakit/react-core/esm/__chunks/JA345JFY.js
...
// node_modules/@ariakit/react-core/esm/__chunks/6HMF3COX.js
...
var useMenubar = createHook(
  function useMenubar2({
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime22.jsx)(MenubarScopedContextProvider, { value: store, children: element }),
      [store]
    );
    if (composite) {
      props = {
...
// node_modules/@ariakit/react-core/esm/__chunks/TJZJUB7X.js
...
// node_modules/@ariakit/react-core/esm/__chunks/5DU47TGY.js
var import_react35 = __toESM(require_react(), 1);
var TagName33 = "p";
var useDialogDescription = createHook(function useDialogDescription2({ store, ...props }) {
  const setDescriptionId = (0, import_react35.useContext)(DialogDescriptionContext);
  const id = useId(props.id);
  useSafeLayoutEffect(() => {
...
// node_modules/@ariakit/react-core/esm/__chunks/YCHWWI4J.js
var TagName34 = "p";
...
// node_modules/@ariakit/react-core/esm/__chunks/NHQBMCYN.js
var import_react36 = __toESM(require_react(), 1);
var TagName35 = "button";
var useButton = createHook(
  function useButton2(props) {
    const ref = (0, import_react36.useRef)(null);
    const tagName = useTagName(ref, TagName35);
    const [isNativeButton, setIsNativeButton] = (0, import_react36.useState)(
...
// node_modules/@ariakit/react-core/esm/__chunks/C22TTW5X.js
...
// node_modules/@ariakit/react-core/esm/__chunks/M5D2PAJU.js
...
// node_modules/@ariakit/react-core/esm/__chunks/L7IQNEVE.js
var import_jsx_runtime24 = __toESM(require_jsx_runtime(), 1);
var TagName38 = "button";
var usePopoverDisclosure = createHook(function usePopoverDisclosure2({ store, ...props }) {
  ...
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime24.jsx)(PopoverScopedContextProvider, { value: store, children: element }),
    [store]
  );
  props = {
    ...props,
...
// node_modules/@ariakit/react-core/esm/__chunks/DG5ESMMT.js
...
var usePopoverDisclosureArrow = createHook(function usePopoverDisclosureArrow2({ store, placement, ...props }) {
  ...
  const children3 = (0, import_react38.useMemo)(
    () => (0, import_jsx_runtime25.jsx)(
      "svg",
      {
        ...
        height: "1em",
        width: "1em",
        children: (0, import_jsx_runtime25.jsx)("polyline", { points })
      }
    ),
    [points]
  );
...
// node_modules/@ariakit/react-core/esm/__chunks/DNJ2MQ45.js
...
var useDialogDismiss = createHook(
  function useDialogDismiss2({ store, ...props }) {
    ...
    const children3 = (0, import_react39.useMemo)(
      () => (0, import_jsx_runtime26.jsxs)(
        "svg",
        {
          ...
          width: "1em",
          children: [
            (0, import_jsx_runtime26.jsx)("line", { x1: "4", y1: "4", x2: "12", y2: "12" }),
            (0, import_jsx_runtime26.jsx)("line", { x1: "4", y1: "12", x2: "12", y2: "4" })
          ]
        }
      ),
      []
...
// node_modules/@ariakit/react-core/esm/__chunks/AJPCB5MS.js
...
// node_modules/@ariakit/react-core/esm/__chunks/VOL6MRTR.js
...
var useHeading = createHook(
  function useHeading2(props) {
    ...
    const level = (0, import_react40.useContext)(HeadingContext) || 1;
    const Element = `h${level}`;
    const tagName = useTagName(ref, Element);
    const isNativeHeading = (0, import_react40.useMemo)(
      () => !!tagName && /^h\d$/.test(tagName),
      [tagName]
    );
    props = {
      render: (0, import_jsx_runtime27.jsx)(Element, {}),
...
// node_modules/@ariakit/react-core/esm/__chunks/JQYZPZOZ.js
var import_react41 = __toESM(require_react(), 1);
var TagName43 = "h1";
var useDialogHeading = createHook(
  function useDialogHeading2({ store, ...props }) {
    const setHeadingId = (0, import_react41.useContext)(DialogHeadingContext);
    const id = useId(props.id);
    useSafeLayoutEffect(() => {
...
// node_modules/@ariakit/react-core/esm/__chunks/BQGZFYES.js
var TagName44 = "h1";
...
// node_modules/@ariakit/react-core/esm/__chunks/QJO65LYO.js
...
// node_modules/@ariakit/react-core/esm/__chunks/SOLFWATP.js
...
var useRadio = createHook(function useRadio2({
  ...
  const tagName = useTagName(ref, TagName45);
...
var useRadioGroup = createHook(
  function useRadioGroup2({ store, ...props }) {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime29.jsx)(RadioScopedContextProvider, { value: store, children: element }),
      [store]
    );
    props = {
      role: "radiogroup",
...
// node_modules/@ariakit/react-core/esm/__chunks/542SHNCE.js
var TagName47 = "span";
...
// node_modules/@ariakit/react-core/esm/__chunks/2UJVL4WQ.js
...
var useCompositeTypeahead = createHook(function useCompositeTypeahead2({ store, typeahead = true, ...props }) {
  ...
  const onKeyDownCaptureProp = props.onKeyDownCapture;
  const cleanupTimeoutRef = (0, import_react43.useRef)(0);
  const onKeyDownCapture = useEvent((event) => {
    onKeyDownCaptureProp == null ? void 0 : onKeyDownCaptureProp(event);
    if (event.defaultPrevented) return;
    if (!typeahead) return;
...
var useSelect = createHook(function useSelect2({
  ...
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime31.jsx)(SelectScopedContextProvider, { value: store, children: element }),
    [store]
  );
  const [autofill, setAutofill] = (0, import_react44.useState)(false);
  const nativeSelectChangedRef = (0, import_react44.useRef)(false);
  ...
  const values = (0, import_react44.useMemo)(() => {
          ...
          "select",
          {
            ...
            children: [
              toArray(value).map((value2) => {
                ...
                return (0, import_jsx_runtime31.jsx)("option", { value: value2, children: value2 }, value2);
              }),
              values.map((value2) => (0, import_jsx_runtime31.jsx)("option", { value: value2, children: value2 }, value2))
            ]
          }
        ),
        element
  ...
  const children3 = (0, import_jsx_runtime31.jsxs)(import_jsx_runtime31.Fragment, { children: [
    value,
    (0, import_jsx_runtime31.jsx)(SelectArrow, {})
  ] });
  const contentElement = useStoreState(store, "contentElement");
  props = {
    role: "combobox",
...
var GroupLabelContext = (0, import_react45.createContext)(void 0);

// node_modules/@ariakit/react-core/esm/__chunks/US7STFPK.js
var import_react46 = __toESM(require_react(), 1);
var import_jsx_runtime32 = __toESM(require_jsx_runtime(), 1);
var TagName51 = "div";
var useGroup = createHook(
  function useGroup2(props) {
    const [labelId, setLabelId] = (0, import_react46.useState)();
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime32.jsx)(GroupLabelContext.Provider, { value: setLabelId, children: element }),
      []
    );
    props = {
      role: "group",
...
// node_modules/@ariakit/react-core/esm/__chunks/MZI3OUH7.js
var TagName52 = "div";
...
// node_modules/@ariakit/react-core/esm/__chunks/IVFWLL4V.js
var import_react47 = __toESM(require_react(), 1);
var TagName54 = "div";
var useGroupLabel = createHook(
  function useGroupLabel2(props) {
    const setLabelId = (0, import_react47.useContext)(GroupLabelContext);
    const id = useId(props.id);
    useSafeLayoutEffect(() => {
...
// node_modules/@ariakit/react-core/esm/__chunks/EZBBDP3V.js
var TagName55 = "div";
...
var useSelectHeading = createHook(
  function useSelectHeading2(props) {
    const [, setHeadingId] = (0, import_react48.useContext)(SelectHeadingContext) || [];
    const id = useId(props.id);
    useSafeLayoutEffect(() => {
      setHeadingId == null ? void 0 : setHeadingId(id);
      return () => setHeadingId == null ? void 0 : setHeadingId(void 0);
...
var useCompositeHover = createHook(
  function useCompositeHover2({
    ...
    const ref = (0, import_react49.useCallback)((element) => {
      if (!element) return;
...
// node_modules/@ariakit/react-core/esm/__chunks/XB7B4NHU.js
...
var useSelectItem = createHook(
  function useSelectItem2({
    ...
    const getItem = (0, import_react50.useCallback)(
      (item) => {
        const nextItem = {
          ...item,
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime33.jsx)(SelectItemCheckedContext.Provider, { value: selected != null ? selected : false, children: element }),
      [selected]
    );
...
var CheckboxCheckedContext = (0, import_react51.createContext)(false);

// node_modules/@ariakit/react-core/esm/__chunks/NCBDBE43.js
var import_react52 = __toESM(require_react(), 1);
var import_jsx_runtime34 = __toESM(require_jsx_runtime(), 1);
var TagName60 = "span";
var checkmark = (0, import_jsx_runtime34.jsx)(
  "svg",
  {
    display: "block",
    fill: "none",
    ...
    height: "1em",
    width: "1em",
    children: (0, import_jsx_runtime34.jsx)("polyline", { points: "4,8 7,12 12,4" })
  }
);
...
var useCheckboxCheck = createHook(
  function useCheckboxCheck2({ store, checked, ...props }) {
    const context = (0, import_react52.useContext)(CheckboxCheckedContext);
...
var useSelectItemCheck = createHook(
  function useSelectItemCheck2({ store, checked, ...props }) {
    const context = (0, import_react53.useContext)(SelectItemCheckedContext);
    checked = checked != null ? checked : context;
...
// node_modules/@ariakit/react-core/esm/__chunks/KM5GWTMX.js
var import_react54 = __toESM(require_react(), 1);
var import_jsx_runtime35 = __toESM(require_jsx_runtime(), 1);
var TagName63 = "div";
var SelectListContext = (0, import_react54.createContext)(null);
var useSelectList = createHook(
  function useSelectList2({
    ...
    const value = useStoreState(store, "value");
    const multiSelectable = Array.isArray(value);
    const [defaultValue2, setDefaultValue] = (0, import_react54.useState)(value);
    const mounted = useStoreState(store, "mounted");
    ...
    const headingContext = (0, import_react54.useContext)(SelectHeadingContext);
    const headingState = (0, import_react54.useState)();
    const [headingId, setHeadingId] = headingContext || headingState;
    const headingContextValue = (0, import_react54.useMemo)(
      () => [headingId, setHeadingId],
      [headingId, setHeadingId]
    );
    const [childStore, setChildStore] = (0, import_react54.useState)(null);
    const setStore = (0, import_react54.useContext)(SelectListContext);
    (0, import_react54.useEffect)(() => {
      if (!setStore) return;
      setStore(store);
    ...
    props = useWrapElement(
      props,
      (element2) => (0, import_jsx_runtime35.jsx)(SelectScopedContextProvider, { value: store, children: (0, import_jsx_runtime35.jsx)(SelectListContext.Provider, { value: setChildStore, children: (0, import_jsx_runtime35.jsx)(SelectHeadingContext.Provider, { value: headingContextValue, children: element2 }) }) }),
...
// node_modules/@ariakit/react-core/esm/__chunks/63IWF7YA.js
...
var useCompositeRow = createHook(
  function useCompositeRow2({
    ...
    const providerValue = (0, import_react55.useMemo)(
      () => ({ id, baseElement, ariaSetSize, ariaPosInSet }),
      [id, baseElement, ariaSetSize, ariaPosInSet]
    );
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime37.jsx)(CompositeRowContext.Provider, { value: providerValue, children: element }),
      [providerValue]
    );
    props = { ...props, id };
    return removeUndefinedValues(props);
...
// node_modules/@ariakit/react-core/esm/__chunks/5QCILLRJ.js
var ctx13 = createStoreContext(
  [CollectionContextProvider],
  [CollectionScopedContextProvider]
);
var useFormContext = ctx13.useContext;
var useFormScopedContext = ctx13.useScopedContext;
var useFormProviderContext = ctx13.useProviderContext;
var FormContextProvider = ctx13.ContextProvider;
var FormScopedContextProvider = ctx13.ScopedContextProvider;
...
var useForm = createHook(function useForm2({
  ...
  const [shouldFocusOnSubmit, setShouldFocusOnSubmit] = (0, import_react57.useState)(false);
  (0, import_react57.useEffect)(() => {
  ...
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime39.jsx)(FormScopedContextProvider, { value: store, children: element }),
    [store]
  );
  const tagName = useTagName(ref, TagName69);
  props = {
...
// node_modules/@ariakit/react-core/esm/__chunks/7LKOJ7WL.js
...
var useFormControl = createHook(
  function useFormControl2({
    ...
    const getItem = (0, import_react58.useCallback)(
      (item) => {
...
// node_modules/@ariakit/react-core/esm/__chunks/6WVG3SIW.js
...
// node_modules/@ariakit/react-core/esm/__chunks/YAFFSPLV.js
var ctx14 = createStoreContext();
var useCheckboxContext = ctx14.useContext;
var useCheckboxScopedContext = ctx14.useScopedContext;
var useCheckboxProviderContext = ctx14.useProviderContext;
var CheckboxContextProvider = ctx14.ContextProvider;
var CheckboxScopedContextProvider = ctx14.ScopedContextProvider;

// node_modules/@ariakit/react-core/esm/__chunks/E2GXNEWF.js
...
var useCheckbox = createHook(
  function useCheckbox2({
    ...
    store = store || context;
    const [_checked, setChecked] = (0, import_react59.useState)(defaultChecked != null ? defaultChecked : false);
    ...
    const tagName = useTagName(ref, TagName71);
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime40.jsx)(CheckboxCheckedContext.Provider, { value: isChecked, children: element }),
      [isChecked]
    );
    props = {
...
var useFormDescription = createHook(
  function useFormDescription2({
    ...
    const name = String(nameProp);
    const getItem = (0, import_react60.useCallback)(
      (item) => {
        const nextItem = {
          ...item,
          id: id || item.id,
...
var useFormError = createHook(
  function useFormError2({
    ...
    const name = String(nameProp);
    const getItem = (0, import_react61.useCallback)(
      (item) => {
    ...
    const children3 = useStoreState(store, () => {
...
// node_modules/@ariakit/react-core/esm/__chunks/MY4F3SH4.js
var TagName76 = "div";
...
var useFormLabel = createHook(
  function useFormLabel2({
    ...
    const name = String(nameProp);
    const getItem = (0, import_react62.useCallback)(
      (item) => {
    ...
    props = {
      render: isNativeLabel ? (0, import_jsx_runtime41.jsx)("label", {}) : (0, import_jsx_runtime41.jsx)("span", {}),
...
// node_modules/@ariakit/react-core/esm/__chunks/ZQHPJX47.js
...
var useFormPush = createHook(
  function useFormPush2({
    ...
    const name = String(nameProp);
    const [shouldFocus, setShouldFocus] = (0, import_react64.useState)(false);
    ...
    const getItem = (0, import_react64.useCallback)(
      (item) => {
...
var useFormRadioGroup = createHook(
  function useFormRadioGroup2({ store, ...props }) {
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime43.jsx)(CompositeScopedContextProvider, { value: void 0, children: element }),
      []
    );
...
// node_modules/@ariakit/react-core/esm/__chunks/LDOHOQAR.js
var TagName87 = "p";
...
var useHovercardDisclosure = createHook(function useHovercardDisclosure2({ store, ...props }) {
  ...
  const children3 = (0, import_jsx_runtime44.jsx)(
    "svg",
    {
      display: "block",
      fill: "none",
      ...
      height: "1em",
      width: "1em",
      children: (0, import_jsx_runtime44.jsx)("polyline", { points: "4,6 8,10 12,6" })
    }
  );
  props = {
    children: children3,
...
// node_modules/@ariakit/react-core/esm/__chunks/HQ7AWW36.js
var TagName89 = "button";
...
// node_modules/@ariakit/react-core/esm/__chunks/XVYBG7NR.js
var TagName90 = "h1";
...
// node_modules/@ariakit/react-core/esm/__chunks/Q35TXJTU.js
...
var MenuItemCheckedContext2 = (0, import_react66.createContext)(
  void 0
);

// node_modules/@ariakit/react-core/esm/__chunks/2ZPKR5QW.js
var import_react67 = __toESM(require_react(), 1);
var import_jsx_runtime46 = __toESM(require_jsx_runtime(), 1);
var TagName91 = "div";
function useAriaLabelledBy({ store, ...props }) {
  const [id, setId] = (0, import_react67.useState)(void 0);
  const label = props["aria-label"];
  const disclosureElement = useStoreState(store, "disclosureElement");
  const contentElement = useStoreState(store, "contentElement");
...
var useMenuList = createHook(
  function useMenuList2({ store, alwaysVisible, composite, ...props }) {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime46.jsx)(MenuScopedContextProvider, { value: store, children: element }),
      [store]
    );
...
var useMenu = createHook(function useMenu2({
  ...
  props = menuListProps;
  const [initialFocusRef, setInitialFocusRef] = (0, import_react68.useState)();
  ...
  (0, import_react68.useEffect)(() => {
    ...
    setInitialFocusRef((prevInitialFocusRef) => {
      ...
      const ref2 = (0, import_react68.createRef)();
      switch (initialFocus) {
        case "first":
  ...
  const preserveTabOrderAnchor = (0, import_react68.useMemo)(() => {
...
var useMenuButton = createHook(
  function useMenuButton2({
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime48.jsx)(MenuContextProvider, { value: store, children: element }),
      [store]
    );
    if (hasParentMenu) {
      props = {
        ...props,
        render: (0, import_jsx_runtime48.jsx)(Role.div, { render: props.render })
      };
    }
    const id = useId(props.id);
    const parentContentElement = useStoreState(
...
// node_modules/@ariakit/react-core/esm/__chunks/626PMZMH.js
var TagName102 = "div";
...
var useMenuItemCheck = createHook(
  function useMenuItemCheck2({ store, checked, ...props }) {
    const context = (0, import_react73.useContext)(MenuItemCheckedContext2);
    checked = checked != null ? checked : context;
    props = useCheckboxCheck({ ...props, checked });
    return props;
  }
...
var useMenuItemRadio = createHook(
  function useMenuItemRadio2({
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime49.jsx)(MenuItemCheckedContext2.Provider, { value: !!isChecked, children: element }),
      [isChecked]
    );
    props = {
      role: "menuitemradio",
...
var useCollection = createHook(
  function useCollection2({ store, ...props }) {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime52.jsx)(CollectionScopedContextProvider, { value: store, children: element }),
      [store]
    );
    return removeUndefinedValues(props);
  }
...
var useCombobox = createHook(
  function useCombobox2({
    ...
    const [canInline, setCanInline] = (0, import_react76.useState)(inline);
    ...
    const scrollingElementRef = (0, import_react76.useRef)(null);
...
var children = (0, import_jsx_runtime54.jsxs)(
  "svg",
  {
    "aria-hidden": "true",
    display: "block",
    ...
    pointerEvents: "none",
    children: [
      (0, import_jsx_runtime54.jsx)("line", { x1: "5", y1: "5", x2: "11", y2: "11" }),
      (0, import_jsx_runtime54.jsx)("line", { x1: "5", y1: "11", x2: "11", y2: "5" })
    ]
  }
);
  ...
  function useComboboxCancel2({ store, hideWhenEmpty, ...props }) {
    ...
    props = useWrapElement(
      ...
      (element) => {
        ...
        if (empty) return (0, import_jsx_runtime54.jsx)(import_react77.Fragment, {});
        return element;
      },
      [hideWhenEmpty, empty]
    );
...
var children2 = (0, import_jsx_runtime55.jsx)(
  "svg",
  {
    "aria-hidden": "true",
    display: "block",
    ...
    width: "1em",
    pointerEvents: "none",
    children: (0, import_jsx_runtime55.jsx)("polyline", { points: "4,6 8,10 12,6" })
  }
);
...
var useComboboxItem = createHook(
  function useComboboxItem2({
    ...
    const { resetValueOnSelectState, multiSelectable, selected } = useStoreStateObject(store, {
      ...
      selected(state) {
        return isSelected2(state.selectedValue, value);
      }
    });
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime56.jsx)(ComboboxItemValueContext.Provider, { value, children: (0, import_jsx_runtime56.jsx)(ComboboxItemCheckedContext.Provider, { value: selected != null ? selected : false, children: element }) }),
      [value, selected]
    );
    const popupRole = (0, import_react78.useContext)(ComboboxListRoleContext);
    props = {
...
var useComboboxItemCheck = createHook(function useComboboxItemCheck2({ store, checked, ...props }) {
  const context = (0, import_react79.useContext)(ComboboxItemCheckedContext);
  checked = checked != null ? checked : context;
  props = useCheckboxCheck({ ...props, checked });
  return props;
});
...
function splitValue(itemValue, userValue) {
  ...
  const parts = [];
  const span = (value, autocomplete = false) => (0, import_jsx_runtime57.jsx)(
    "span",
    {
...
var useComboboxItemValue = createHook(function useComboboxItemValue2({ store, value, userValue, ...props }) {
  const context = useComboboxScopedContext();
  store = store || context;
  const itemContext = (0, import_react80.useContext)(ComboboxItemValueContext);
  const itemValue = value != null ? value : itemContext;
  const inputValue = useStoreState(store, (state) => userValue != null ? userValue : state == null ? void 0 : state.value);
  const children3 = (0, import_react80.useMemo)(() => {
    if (!itemValue) return;
...
var useComboboxList = createHook(
  function useComboboxList2({ store, alwaysVisible, ...props }) {
    ...
    const [hasListboxInside, setHasListboxInside] = (0, import_react81.useState)(false);
    const contentElement = useStoreState(store, "contentElement");
    useSafeLayoutEffect(() => {
      if (!mounted) return;
      const element = ref.current;
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime58.jsx)(ComboboxScopedContextProvider, { value: store, children: (0, import_jsx_runtime58.jsx)(ComboboxListRoleContext.Provider, { value: role, children: element }) }),
      [store, role]
    );
...
var useComboboxPopover = createHook(
  function useComboboxPopover2({
    ...
    const baseElement = useStoreState(store, "baseElement");
    const hiddenByClickOutsideRef = (0, import_react82.useRef)(false);
...
var TagValueContext = (0, import_react83.createContext)(null);
var TagRemoveIdContext = (0, import_react83.createContext)(
  null
);
...
var useTagContext = ctx15.useContext;
var useTagScopedContext = ctx15.useScopedContext;
var useTagProviderContext = ctx15.useProviderContext;
var TagContextProvider = ctx15.ContextProvider;
var TagScopedContextProvider = ctx15.ScopedContextProvider;
...
function ComboboxProvider(props = {}) {
  ...
  return (0, import_jsx_runtime59.jsx)(ComboboxContextProvider, { value: store, children: props.children });
}
...
// node_modules/@medusajs/dashboard/dist/chunk-OFN7DIZA.mjs
      ...
      children: [
        (0, import_jsx_runtime63.jsxs)(
          "div",
          {
            ...
            children: [
              showTag && (0, import_jsx_runtime63.jsxs)(
                "button",
                {
                  type: "button",
                  onClick: (e) => {
                  ...
                  children: [
                    (0, import_jsx_runtime63.jsx)("span", { className: "tabular-nums", children: selectedValues.length }),
                    (0, import_jsx_runtime63.jsx)(XMarkMini, { className: "text-ui-fg-muted" })
                  ]
                }
              ),
              (0, import_jsx_runtime63.jsxs)("div", { className: "relative flex size-full items-center", children: [
                showSelected && (0, import_jsx_runtime63.jsx)(
                  "div",
                  {
                    className: clx(
                    ...
                    children: (0, import_jsx_runtime63.jsx)(Text, { size: "small", leading: "compact", children: t("general.selected") })
                  }
                ),
                hideInput && (0, import_jsx_runtime63.jsx)(
                  "div",
                  {
                    className: clx(
                    ...
                    children: (0, import_jsx_runtime63.jsx)(Text, { size: "small", leading: "compact", className: "truncate", children: selectedLabel })
                  }
                ),
              ...
              allowClear && controlledValue && (0, import_jsx_runtime63.jsx)(
                "button",
                {
                  type: "button",
                  onClick: (e) => {
                  ...
                  children: (0, import_jsx_runtime63.jsx)(XMarkMini, { className: "text-ui-fg-muted" })
                }
              ),
              (0, import_jsx_runtime63.jsx)(
                ComboboxDisclosure,
                  ...
                  render: (props) => {
                    return (0, import_jsx_runtime63.jsx)(
                      "button",
                      {
                        ...
                        children: (0, import_jsx_runtime63.jsx)(TrianglesMini, {})
                      }
                    );
                  }
                }
        ...
        (0, import_jsx_runtime63.jsxs)(
          ComboboxPopover,
          {
            ...
            "aria-busy": isPending,
            children: [
              results.map(({ value, label, disabled }) => (0, import_jsx_runtime63.jsxs)(
                ComboboxItem,
                {
                  value,
                  focusOnHover: true,
                  ...
                  children: [
                    (0, import_jsx_runtime63.jsx)(ComboboxItemCheck, { className: "flex !size-5 items-center justify-center", children: isArrayValue ? (0, import_jsx_runtime63.jsx)(CheckMini, {}) : (0, import_jsx_runtime63.jsx)(EllipseMiniSolid, {}) }),
                    (0, import_jsx_runtime63.jsx)(ComboboxItemValue, { className: "txt-compact-small", children: label })
                  ]
                },
                value
              )),
              !!fetchNextPage && (0, import_jsx_runtime63.jsx)("div", { ref: lastOptionRef, className: "w-px" }),
              isFetchingNextPage && (0, import_jsx_runtime63.jsx)("div", { className: "transition-fg bg-ui-bg-base flex items-center rounded-[4px] px-2 py-1.5", children: (0, import_jsx_runtime63.jsx)("div", { className: "bg-ui-bg-component size-full h-5 w-full animate-pulse rounded-[4px]" }) }),
              !results.length && (noResultsPlaceholder && !(searchValue == null ? void 0 : searchValue.length) ? noResultsPlaceholder : (0, import_jsx_runtime63.jsx)("div", { className: "flex items-center gap-x-2 rounded-[4px] px-2 py-1.5", children: (0, import_jsx_runtime63.jsx)(
                Text,
                {
                  size: "small",
                  leading: "compact",
              ...
              !results.length && onCreateOption && (0, import_jsx_runtime63.jsxs)(import_react85.Fragment, { children: [
                (0, import_jsx_runtime63.jsx)(Separator, { className: "bg-ui-border-base -mx-1" }),
                (0, import_jsx_runtime63.jsxs)(
                  ComboboxItem,
                  {
                    value: uncontrolledSearchValue,
                    ...
                    children: [
                      (0, import_jsx_runtime63.jsx)(PlusMini, { className: "text-ui-fg-subtle" }),
                      (0, import_jsx_runtime63.jsxs)(Text, { size: "small", leading: "compact", children: [
                        t("actions.create"),
                        ' "',
                        searchValue,
                        '"'
...
//# sourceMappingURL=chunk-UMUYNGM3.js.map
