...
export declare const AdminGetOrdersOrderParams: z.ZodObject<{
    ...
    version: z.ZodEffects<z.ZodOptional<z.ZodNumber>, number | undefined, unknown>;
}, "strip", z.ZodTypeAny, {
...
export declare const AdminGetOrdersParams: z.ZodEffects<z.ZodObject<{
    fields: z.ZodOptional<z.ZodString>;
} & {
    ...
    total: z.ZodOptional<z.ZodUnion<[any, z.ZodObject<{
        $eq: any;
        $ne: any;
        $in: any;
        $nin: any;
