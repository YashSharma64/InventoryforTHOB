...
exports.AdminGetOrdersOrderParams = (0, validators_1.createSelectParams)().merge(zod_1.z.object({
    version: zod_1.z.preprocess((val) => {
        if ((0, utils_1.isString)(val) && val) {
            return parseInt(val);
        }
        return val;
...
const AdminGetOrdersParamsBase = (0, validators_1.createFindParams)({
    limit: 15,
    offset: 0,
    ...
    total: (0, validators_1.createOperatorMap)().optional(),
}));
const AdminGetOrdersParamsTransform = (v) => {
    const { total, ...rest } = v;
    return {
        ...rest,
...
exports.AdminGetOrdersParams = AdminGetOrdersParamsBase.transform(AdminGetOrdersParamsTransform);
