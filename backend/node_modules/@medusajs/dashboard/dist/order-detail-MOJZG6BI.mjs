...
import {
  ...
  useClaims
} from "./chunk-OSOP3FZ6.mjs";
import {
  useCancelExchange,
  useCancelExchangeRequest,
  useExchanges
} from "./chunk-I6BXBC6Z.mjs";
import {
  useCancelOrderEdit,
  useConfirmOrderEdit
} from "./chunk-BL35EQYL.mjs";
import {
  getLoyaltyPlugin
  ...
  return useMemo2(() => {
    ...
    for (const fulfillment of order.fulfillments || []) {
      ...
      if (fulfillment.shipped_at) {
        items.push({
          ...
          children: /* @__PURE__ */ jsxs8("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2", children: [
            /* @__PURE__ */ jsx7(FulfillmentCreatedBody, { fulfillment, isShipment: true }),
    ...
    for (const ret of returns) {
      ...
      items.push({
        ...
        itemsMap,
        children: /* @__PURE__ */ jsxs8("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2", children: [
          /* @__PURE__ */ jsx7(ReturnBody, { orderReturn: ret, isCreated: !ret.canceled_at }),
...
var OrderEditBody = ({ edit }) => {
  ...
  const ItemChangeDetails = ({
    ...
    return /* @__PURE__ */ jsx7("div", { className: "text-ui-fg-subtle flex flex-col divide-y divide-dashed", children: lineItems.map((orderItem) => {
      ...
      return /* @__PURE__ */ jsxs8("div", { className: "group flex items-start gap-x-4 py-3 first:pt-0 last:pb-0", children: [
