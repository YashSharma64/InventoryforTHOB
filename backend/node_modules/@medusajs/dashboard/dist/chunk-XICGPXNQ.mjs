...
var DataTableQuery = ({
  ...
  return (search || orderBy || filters || prefix) && /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between gap-x-4 px-6 py-4", children: [
    /* @__PURE__ */ jsx2("div", { className: "w-full max-w-[60%]", children: filters && filters.length > 0 && /* @__PURE__ */ jsx2(DataTableFilter, { filters, prefix }) }),
    /* @__PURE__ */ jsxs("div", { className: "flex shrink-0 items-center gap-x-2", children: [
      ...
      orderBy && /* @__PURE__ */ jsx2(DataTableOrderBy, { keys: orderBy, prefix })
    ] })
  ] });
};
  ...
  return /* @__PURE__ */ jsxs2(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx3(
          "div",
          {
            ...
            children: !noResults ? /* @__PURE__ */ jsxs2(Table, { className: "relative w-full", children: [
              !noHeader && /* @__PURE__ */ jsx3(Table.Header, { className: "border-t-0", children: table.getHeaderGroups().map((headerGroup) => {
              ...
              /* @__PURE__ */ jsx3(Table.Body, { className: "border-b-0", children: table.getRowModel().rows.map((row) => {
                    ...
                    children: cells.map((cell, index) => {
                      ...
                      return /* @__PURE__ */ jsx3(
                        Table.Cell,
                        {
                          ...
                          children: shouldRenderAsLink ? /* @__PURE__ */ jsx3(
                            Link,
                            {
                              to,
            ...
            ] }) : /* @__PURE__ */ jsx3("div", { className: clx({ "border-b": layout === "fit" }), children: /* @__PURE__ */ jsx3(NoResults, {}) })
          }
        ),
        pagination && /* @__PURE__ */ jsx3("div", { className: clx({ "border-t": layout === "fill" }), children: /* @__PURE__ */ jsx3(
          Pagination,
          {
        ...
        hasCommandBar && /* @__PURE__ */ jsx3(CommandBar, { open: !!Object.keys(rowSelection).length, children: /* @__PURE__ */ jsxs2(CommandBar.Bar, { children: [
          ...
          commands?.map((command, index) => {
            return /* @__PURE__ */ jsxs2(Fragment, { children: [
              ...
              index < commands.length - 1 && /* @__PURE__ */ jsx3(CommandBar.Seperator, {})
            ] }, index);
          })
        ] }) })
      ]
