...
.start-\[calc\(var\(--tag-width\)\+8px\)\] {
  inset-inline-start: calc(var(--tag-width) + 8px);
}
.top-0 {
  top: 0px;
}
...
.ps-\[calc\(var\(--tag-width\)\+8px\)\] {
  padding-inline-start: calc(var(--tag-width) + 8px);
}
.pt-0 {
  padding-top: 0px;
}
