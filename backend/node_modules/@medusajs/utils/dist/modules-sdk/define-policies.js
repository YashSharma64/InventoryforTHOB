...
exports.PolicyResource = exports.PolicyOperation = exports.Policy = exports.MedusaPolicySymbol = void 0;
...
const PolicyOperation = global.PolicyOperation ?? { ALL: "*" };
...
function definePolicies(policies) {
    ...
    for (const policy of policiesArray) {
        const resourceKey = policy.resource === "*" ? "*" : (0, to_snake_case_1.toSnakeCase)(policy.resource);
        const operationKey = policy.operation === "*" ? "*" : (0, to_snake_case_1.toSnakeCase)(policy.operation);
